...
resources:
  - path: references/api-keys.md
    type: file
  - path: references/auth.md
    type: file
  - path: references/automations.md
    type: file
  - path: references/broadcasts.md
    type: file
  - path: references/contact-properties.md
    type: file
  - path: references/contacts.md
    type: file
  - path: references/domains.md
    type: file
  - path: references/emails.md
    type: file
  - path: references/error-codes.md
    type: file
  - path: references/logs.md
    type: file
  - path: references/segments.md
    type: file
  - path: references/templates.md
    type: file
  - path: references/topics.md
    type: file
...
Do not download and pipe a remote installer into a shell. If neither npm nor
Homebrew is available, stop and ask the operator to install a reviewed release
artifact through their normal package-management workflow.
