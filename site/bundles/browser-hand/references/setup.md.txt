...
If you previously loaded `dev-browser` or `extension/.output/chrome-mv3`, remove that legacy unpacked extension first (or run `npm run setup -- --cleanup-legacy` for skill cleanup + printed Chrome steps).
